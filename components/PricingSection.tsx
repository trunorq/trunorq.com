...
const features: PricingFeature[] = [
    { name: "Lead sync discrepancy detection", included: "starter" },
    { name: "Up to 10,000 leads/month", included: "starter" },
    { name: "Basic GCLID matching", included: "starter" },
    { name: "Email support", included: "starter" },
    { name: "4-strategy matching engine", included: "pro" },
    { name: "Up to 100,000 leads/month", included: "pro" },
    { name: "Auto-sync missing leads to CRM", included: "pro" },
    { name: "Priority support", included: "pro" },
    { name: "Custom matching rules", included: "enterprise" },
    { name: "Unlimited leads", included: "enterprise" },
    { name: "Dedicated account manager", included: "enterprise" },
    { name: "24/7 phone support", included: "enterprise" },
    { name: "5 CSV reports (matched, missing, delayed, duplicates, campaign)", included: "all" },
    { name: "Campaign attribution dashboard", included: "all" },
]
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="font-figtree text-lg text-muted-foreground max-w-2xl mx-auto">
                        Get started with Trunorq's CRM operations platform. All plans include CSV reports and campaign
                        attribution.
                    </p>
                </div>
