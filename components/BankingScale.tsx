...
const stats: StatItem[] = [
    {
        value: "2.4M+",
        description: "Leads audited\nacross platforms",
        delay: 0,
    },
    {
        value: "98.7%",
        description: "Match accuracy via\n4-strategy engine",
        delay: 0.2,
    },
    {
        value: "6+",
    ...
    {
        value: "340+",
        description: "RevOps teams using\nTrunorq",
        delay: 0.6,
    },
]
            ...
            <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
                <div className="grid grid-cols-12 gap-5 gap-y-16">
                    <div className="col-span-12 md:col-span-6 relative z-10">
                        ...
                        >
                            Auditing millions of leads daily{" "}
                            <span
                            ...
                            >
                                for the world's most data-driven RevOps teams and performance marketers.
                            </span>
                        </h2>
                        ...
                        >
                            As the intelligence layer for CRM operations, we provide real-time lead sync auditing and attribution
                            through our advanced 4-strategy matching engine.
                        </p>
