...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
    const {
        dailyVolume = "2,430,992",
        dailyVolumeLabel = "LEADS AUDITED THIS MONTH",
        headline = "Fix Your CRM. Trace Every Lead.",
        subheadline = "Trunorq connects your ad platforms and CRMs into a unified audit layer — finding missing conversions, flagging delayed syncs, and detecting duplicates across your entire pipeline.",
        description = "Trusted by performance marketers and RevOps teams, Trunorq powers smarter attribution across 340+ organizations — with enterprise-grade security and a 4-strategy matching engine.",
